let User,Role,decryptMessage,mongoose,jwt,configuration;_2f6‍.x([["default",()=>_2f6‍.o]]);_2f6‍.w("../db/schema/users",[["default",["User"],function(v){User=v}]]);_2f6‍.w("../db/schema/role",[["default",["Role"],function(v){Role=v}]]);_2f6‍.w("../encryptDecrypt",[["decryptMessage",["decryptMessage"],function(v){decryptMessage=v}]]);_2f6‍.w("mongoose",[["default",["mongoose"],function(v){mongoose=v}]]);_2f6‍.w("jsonwebtoken",[["default",["jwt"],function(v){jwt=v}]]);_2f6‍.w("../appConfig",[["default",["configuration"],function(v){configuration=v}]]);/*
...
const validateUser = (user,password) => new Promise((resolve,reject) => {
    ...
    _2f6‍.g.console.log("decrypted PP",decryptedPassword);
...
const userLogin = async (req,res) =>{
    try {
        ...
        if (req.body && req.body.email && req.body.password) {
            ...
            _2f6‍.g.console.log("required user",requiredUser);
            if(requiredUser){
        ...
        res.sendStatus(403);
        _2f6‍.g.console.log("getting error while processing the user login",err);
    }
}
