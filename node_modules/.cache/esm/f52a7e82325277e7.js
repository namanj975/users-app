let users;_325‍.x([["default",()=>filterDeactivatedUsers],["getAllUserNamesInArray",()=>getUserFirstAndLastNameAppended],["getUserscount",()=>getCountOfUsersAfterGivenDate],["sortedUsers",()=>sortUsersByDate],["getUsers",()=>getUsers]]);_325‍.w("./users.json",[["default",["users"],function(v){users=v}]]);/*
...
const getUsers = async (invocation) => {
  try {
    _325‍.g.console.log("getting all users from invocation ", invocation);
    return users;
  } catch(err){
...
getUsers(1).then(filterDeactivatedUsers).then(getUserFirstAndLastNameAppended).then(users => _325‍.g.console.log(users));
getUsers(2).then((result) => getCountOfUsersAfterGivenDate({role:"student", "date": 1611155600000})).then(count => _325‍.g.console.log("count of users", count));
