let User,Role;_301‍.x([["default",()=>_301‍.o]]);_301‍.w("../db/schema/users",[["default",["User"],function(v){User=v}]]);_301‍.w("../db/schema/role",[["default",["Role"],function(v){Role=v}]]);/*
...
const listUsers = async (req, res) => {
    try {
        if (req.query && req.query.role) {
            ...
            _301‍.g.console.log("all users and all roles", allRoles, allUsers);
            return res.json({ success: true, data: { users: fiteredUsers } });
        }
    } catch (err) {
        res.sendStatus(403);
        _301‍.g.console.log("getting error while listing the users...", err);
    }
}
